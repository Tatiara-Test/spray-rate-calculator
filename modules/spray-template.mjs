export const SPRAY_TEMPLATE = `
  ...
  <div class="spray-root">
    <main class="app-shell">
      ...
      <div id="calculator-view" data-view-panel="calculator">
        ...
        <section class="calculator-card products-card" aria-labelledby="products-heading">
          ...
          <div class="product-list" id="product-list"></div><button class="add-product" id="add-product" type="button">+ Add product 5</button>
        </section>
      ...
      <section id="paddocks-view" data-view-panel="paddocks" hidden aria-labelledby="paddocks-heading">
    ...
    <dialog class="save-dialog" id="save-dialog"><form method="dialog" class="save-panel" id="save-form">
      ...
      <datalist id="paddock-suggestions"></datalist><datalist id="chemical-suggestions"></datalist>
      ...
      <div class="save-products"><h3>Chemical names</h3><p>Enter a name for each product used.</p><div id="save-product-list"></div></div>
    ...
    <dialog class="save-dialog" id="share-review-dialog"><form method="dialog" class="save-panel" id="share-review-form">
      ...
      <p class="review-help">Every included tank needs its own operator and machine before a copy can be exported or shared.</p><div id="share-review-list"></div><p class="dialog-error" id="share-review-error" hidden></p>
